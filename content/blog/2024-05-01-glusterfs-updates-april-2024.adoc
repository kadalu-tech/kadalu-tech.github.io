...
After trying out many options, we started a new project to provide the modern features on top of Glusterd. Glusterd Plus provides ReST APIs, Web Console and many other features on top of Glusterd and provides the framework to implement new features. Refer link:/blog/project-update-glusterd-plus[this blog post] to learn about the Glusterd Plus project.
